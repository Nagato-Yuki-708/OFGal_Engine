...
## 如何开始运行场景
我们需要先打开一个场景，再找到一个标题为OFGal_Engine的窗口，焦点在其上时按下Enter即可开始运行，后面不管该窗口是否有焦点它都能读取到按键（即全局捕捉）

![image-20260517141825387](README.assets/image-20260517141825387.png)

运行期间，按下Esc会再下一个节点执行前退出运行状态